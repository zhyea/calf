...
public class ChapterUploadComponent {
    ...
    private static final String PATTERN_VOLUME = "^第?[\\s]{0,9}[\\d〇零一二三四五六七八九十百千万上中下０１２３４５６７８９　\\s]{1,6}[\\s]{0,9}[、，．\\.]?[章回节卷部篇讲集分]{0,2}([\\s]{1,9}.{0,32})?$";

    private static final List<String> ARRAY_SHORT = Arrays.asList("楔子", "引子", "引言", "前言", "序章", "序言", "序曲", "尾声", "终章", "后记", "序", "序幕", "跋", "附", "附言");
